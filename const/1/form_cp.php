...
// Check if client_id is set and is not empty
if (isset($_GET['client_id']) && !empty($_GET['client_id'])) {
    $client_id = htmlspecialchars($_GET['client_id'], ENT_QUOTES, 'UTF-8');

    // Modify the SQL query to filter by client_id
    $query = "
        SELECT 
            o.client_id,
            o.project_id,
    ...
    // If no client_id is provided, return an error or all records
...
<div id="mediaModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        <!-- Include modals -->
        <?php include('includes/modals_form_pc.php'); 
		include('includes/updateModal.php'); 
        include_once 'scripts_form_cp.php';
